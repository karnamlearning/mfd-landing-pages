...
indian-family.jpg is credited above but is not used in this template.

License check (Sep 2026): listed Unsplash photos are under the Unsplash License (free personal and commercial use; attribution not required). Default Next.js SVGs in /public (file, globe, next, vercel, window) are unused. Images inside news, blog, and mutual-fund HTML come from Advisorkhoj / AMCs and are not part of this Unsplash set.
